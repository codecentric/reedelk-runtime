...
public interface Message extends Serializable {
    ...
    @AutocompleteItem(returnType = TypedContent.class, replaceValue = "content()",
            description = "Returns the message content of this message. The message content contains information about the payload's mime type, data type and stream status.")
     ...
     */
    @AutocompleteItem(returnType = Object.class, replaceValue = "payload()", description = "Returns the payload data of this message.")
     ...
     */
    @AutocompleteItem(replaceValue = "getAttributes()", description = "Returns the attributes belonging to this message.")
     ...
     * @return the message attributes.
     */
    @AutocompleteItem(replaceValue = "attributes()", description = "Returns the attributes belonging to this message.")
