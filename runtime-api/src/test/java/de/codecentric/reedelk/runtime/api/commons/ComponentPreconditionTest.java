...
import de.codecentric.reedelk.runtime.api.commons.ComponentPrecondition.Input;
...
class ComponentPreconditionTest {
    ...
    void shouldThrowExceptionWhenInputSubclassOfNotExpected() {
        ...
        // Then
        String expected = "TestComponent (de.codecentric.reedelk.runtime.api.commons.TestComponent) was invoked with " +
