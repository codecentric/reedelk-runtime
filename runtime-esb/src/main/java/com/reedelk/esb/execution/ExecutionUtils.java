...
class ExecutionUtils {
    ...
    static Optional<ExecutionNode> nextNodeOf(ExecutionNode current, ExecutionGraph graph) {
        return current == null ?
                Optional.empty() :
     ...
     */
    static ExecutionNode nextNodeOfOrThrow(ExecutionNode current, ExecutionGraph graph) {
