...
public class RuntimeConfiguration extends Properties {
    ...
    public static Map<String, String> get() {
        ...
        // NAME_CONVENTION
        configuration.put("de.codecentric.reedelk.system.api.configuration.config.directory", SystemConfiguration.configDirectory());
        // NAME_CONVENTION
        configuration.put("de.codecentric.reedelk.system.api.configuration.home.directory", SystemConfiguration.homeDirectory());
        // NAME_CONVENTION
        configuration.put("de.codecentric.reedelk.system.api.configuration.modules.directory", SystemConfiguration.modulesDirectory());
        // NAME_CONVENTION
        configuration.put("de.codecentric.reedelk.system.api.configuration.runtime.version", Version.getVersion());
        // NAME_CONVENTION
        configuration.put("de.codecentric.reedelk.system.api.configuration.runtime.qualifier", Version.getQualifier());
