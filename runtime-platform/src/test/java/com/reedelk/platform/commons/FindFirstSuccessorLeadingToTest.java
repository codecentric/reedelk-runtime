...
class FindFirstSuccessorLeadingToTest {
    ...
    void shouldReturnFirstSuccessorLeadingToExecutionNodeThrowExceptionWhenExecutionNodeNotFound() {
        ...
        assertThat(thrown).hasMessage("Could not find first successor of component=[com.reedelk.platform.test.utils.TestComponent], leading to component=[com.reedelk.platform.test.utils.TestComponent]");
    }
}
