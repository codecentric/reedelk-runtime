...
class ModuleResolveDependenciesTest {
    ...
    void shouldReturnModuleWithStateUnresolvedWhenNotAllFlowComponentsArePresent() {
        // Given
        doReturn(singletonList("com.reedelk.platform.not.found.Component"))
    ...
    void shouldReturnModuleWithStateUnresolvedWhenNotAllSubFlowComponentsArePresent() {
        ...
        doAnswer(invocation -> {
            ...
            if (argument.containsAll(asList("com.reedelk.platform.test.utils.SubFlowComponent", "com.reedelk.platform.test.utils.AnotherSubFlowComponent"))) {
                return singletonList("com.reedelk.platform.test.utils.SubFlowComponent");
            }
            return emptyList();
        }).when(componentRegistry)
    ...
    void shouldReturnModuleWithStateUnresolvedWhenNotAllConfigComponentsArePresent() {
        ...
        doAnswer(invocation -> {
            ...
            if (originalArgument.contains("com.reedelk.platform.test.utils.TestConfiguration")) {
                return singletonList("com.reedelk.platform.test.utils.TestConfiguration");
            }
            return emptyList();
        }).when(componentRegistry)
                .unregisteredComponentsOf(ArgumentMatchers.anyCollection());
    ...
    void shouldReturnModuleWithStateUnresolvedWithCorrectResolvedAndUnresolvedSets() {
        // Given
        doReturn(asList("com.reedelk.platform.test.utils.AnotherTestComponent", "com.reedelk.platform.test.utils.TestInboundComponent"))
                .when(componentRegistry)
                .unregisteredComponentsOf(anyCollection());
        ...
        assertThat(unresolvedComponents).containsExactlyInAnyOrder(
                "com.reedelk.platform.test.utils.AnotherTestComponent",
                "com.reedelk.platform.test.utils.TestInboundComponent");
