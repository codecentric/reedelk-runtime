...
class ModuleTest {
    ...
    private final Collection<String> unresolvedComponents = asList("com.reedelk.platform.Unresolved1", "com.reedelk.platform.Unresolved2");
    private final Collection<String> resolvedComponents = asList("com.reedelk.platform.Resolved1", "com.reedelk.platform.Resolved2");
