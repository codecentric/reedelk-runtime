...
class ValueConverterFactoryTest {
    ...
    class ConvertException {
        ...
        void shouldThrowExceptionWhenConverterNotPresent() {
            ...
            assertThat(exception).hasMessage("Converter for input=[com.reedelk.platform.services.scriptengine.converter.ValueConverterFactoryTest$DummyClazz] to output=[java.lang.Integer] not available");
        }
