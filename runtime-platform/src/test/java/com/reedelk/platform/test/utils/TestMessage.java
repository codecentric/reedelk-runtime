...
public enum TestMessage {
    ...
    FLOW_ERROR_MESSAGE_DEFAULT_WITH_NULL_CORRELATION_ID {
        @Override
        String path() {
            return "/com/reedelk/platform/commons/flow_error_default_message_without_correlation_id.json";
        }
    },
    ...
    FLOW_ERROR_MESSAGE_DEFAULT {
        @Override
        String path() {
            return "/com/reedelk/platform/commons/flow_error_default_message.json";
        }
    };
