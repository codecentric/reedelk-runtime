...
class FindFirstSuccessorLeadingToTest {
    ...
    void shouldReturnFirstSuccessorLeadingToExecutionNodeThrowExceptionWhenExecutionNodeNotFound() {
        ...
        assertThat(thrown).hasMessage("Could not find first successor of component=[de.codecentric.reedelk.platform.test.utils.TestComponent], leading to component=[de.codecentric.reedelk.platform.test.utils.TestComponent]");
    }
}
