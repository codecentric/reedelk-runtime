...
class RouterDeserializerTest extends AbstractDeserializerTest {
    ...
    private ExecutionNode routerExecutionNode = new ExecutionNode(new ExecutionNode.ReferencePair<>(new RouterWrapper()));
    ...
    void shouldCorrectlyDeserializeRouterComponent() {
        ...
        whenArray.put(conditionalBranch(Router.DEFAULT_CONDITION.value(), component6Name, component5Name));
