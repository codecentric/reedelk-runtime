...
class ExecutionNodeTest {
    ...
    void shouldReturnCorrectComponentReference() {
        // Given
        ExecutionNode.ReferencePair<Component> expectedReference = new ExecutionNode.ReferencePair<>(testComponent, serviceReference);
        ExecutionNode EN = new ExecutionNode(expectedReference);

        // When
        ExecutionNode.ReferencePair<Component> actualReference = EN.getComponentReference();
    ...
    void shouldAddDependencyReferenceCorrectly() {
        ...
        ExecutionNode.ReferencePair<Implementor> referencePairDependency1 = mockReferencePair(new Dependency());
        testComponentEN.add(referencePairDependency1);

        ExecutionNode.ReferencePair<Implementor> referencePairDependency2 = mockReferencePair(new Dependency());
        testComponentEN.add(referencePairDependency2);

        // When
        List<ExecutionNode.ReferencePair<Implementor>> actualDependencyReferences = testComponentEN.getDependencyReferences();
    ...
    void shouldClearReferencesRemoveAllReferences() {
        ...
        ExecutionNode.ReferencePair<Implementor> dependencyReferencePair1 = mockReferencePair(new Dependency());
        testComponentEN.add(dependencyReferencePair1);

        ExecutionNode.ReferencePair<Implementor> dependencyReferencePair2 = mockReferencePair(new Dependency());
    ...
    void shouldClearReferencesCallDisposeOnComponentAndDependentImplementors() {
        ...
        ExecutionNode.ReferencePair<Implementor> dependencyReferencePair1 = mockReferencePair(dependency1);
        testComponentEN.add(dependencyReferencePair1);

        Dependency dependency2 = spy(new Dependency());
        ExecutionNode.ReferencePair<Implementor> dependencyReferencePair2 = mockReferencePair(dependency2);
        testComponentEN.add(dependencyReferencePair2);
    ...
    private ExecutionNode.ReferencePair<Implementor> mockReferencePair(Implementor implementor) {
        ServiceReference<Implementor> dependencyServiceReference = mock(ServiceReference.class);
        return new ExecutionNode.ReferencePair<>(implementor, dependencyServiceReference);
    }
