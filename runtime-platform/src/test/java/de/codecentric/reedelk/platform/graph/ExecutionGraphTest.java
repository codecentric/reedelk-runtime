...
import de.codecentric.reedelk.platform.test.utils.AnotherTestComponent;
...
class ExecutionGraphTest {
    ...
    void shouldThrowExceptionWhenPutEdgeAndN1NotAddedAlready() {
        // Given
        ExecutionNode n1 = new ExecutionNode(new ExecutionNode.ReferencePair<>(new TestInboundComponent()));
        ExecutionNode n2 = new ExecutionNode(new ExecutionNode.ReferencePair<>(new TestComponent()));
    ...
    void shouldThrowExceptionWhenRootAlreadyPresentAndNXIsNull() {
        // Given
        ExecutionNode n1 = new ExecutionNode(new ExecutionNode.ReferencePair<>(new TestInboundComponent()));
        ExecutionNode n2 = new ExecutionNode(new ExecutionNode.ReferencePair<>(new TestInboundComponent()));
        graph.putEdge(null, n1);
    ...
    void shouldThrowExceptionWhenRootIsNotInbound() {
        // Given
        ExecutionNode n1 = new ExecutionNode(new ExecutionNode.ReferencePair<>(new TestComponent()));
    ...
    void shouldSuccessorsReturnCorrectSuccessors() {
        ...
        ExecutionNode n1 = new ExecutionNode(new ExecutionNode.ReferencePair<>(new TestInboundComponent()));
        ExecutionNode n2 = new ExecutionNode(new ExecutionNode.ReferencePair<>(new TestComponent()));
        ExecutionNode n3 = new ExecutionNode(new ExecutionNode.ReferencePair<>(new TestComponent()));
        ExecutionNode n4 = new ExecutionNode(new ExecutionNode.ReferencePair<>(new TestComponent()));
        ...
        // Then
        org.assertj.core.api.Assertions.assertThat(successors).containsExactlyInAnyOrder(n2, n3);
    }
    ...
    void shouldApplyOnNodesTraverseAllNodes() {
        ...
        // Then
        org.assertj.core.api.Assertions.assertThat(visited).containsExactlyInAnyOrder(n1, n2, n3, n4);
    }
    ...
    void shouldFindOneReturnEmpty() {
        ...
        // Then
        org.assertj.core.api.Assertions.assertThat(maybeOne).isEmpty();
    }
    ...
    void shouldFindOneReturnExistingNodeMatchingCondition() {
        ...
        // Then
        org.assertj.core.api.Assertions.assertThat(maybeOne).get().isEqualTo(n2);
    }
