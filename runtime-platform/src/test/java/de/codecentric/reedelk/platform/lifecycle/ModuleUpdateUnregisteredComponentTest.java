...
class ModuleUpdateUnregisteredComponentTest {
    ...
    void shouldRemoveComponentFromResolvedModule() {
        ...
        // Then
        assertThat(unresolvedModule.state()).isEqualTo(ModuleState.UNRESOLVED);
    ...
    void shouldThrowExceptionWhenStateIsInstalled() {
        ...
        Mockito.doReturn(ModuleState.INSTALLED).when(module).state();
    ...
    void shouldThrowExceptionWhenStateIsStarted() {
        // Given
        Module module = mock(Module.class);
        Mockito.doReturn(ModuleState.STARTED).when(module).state();
    ...
    void shouldThrowExceptionWhenStateIsStopped() {
        // Given
        Module module = mock(Module.class);
        Mockito.doReturn(ModuleState.STOPPED).when(module).state();
