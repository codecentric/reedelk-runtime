...
class ModuleTest {
    ...
    private final Collection<String> unresolvedComponents = asList("de.codecentric.reedelk.platform.Unresolved1", "de.codecentric.reedelk.platform.Unresolved2");
    private final Collection<String> resolvedComponents = asList("de.codecentric.reedelk.platform.Resolved1", "de.codecentric.reedelk.platform.Resolved2");
    ...
    class Installed {
        ...
        void shouldInitialStateBeInstalled() {
            ...
            // Then
            assertThat(state).isEqualTo(ModuleState.INSTALLED);
        }
        ...
        void shouldInstalledTransitionToErrorState() {
            ...
            // Then
            assertStateIs(ModuleState.ERROR);
        }
        ...
        void shouldInstalledTransitionToUnresolvedState() {
            ...
            // Then
            assertStateIs(ModuleState.UNRESOLVED);
        }
    ...
    class Unresolved {
        ...
        void shouldUnresolvedTransitionToResolved() {
            ...
            // Then
            assertStateIs(ModuleState.RESOLVED);
        }
        ...
        void shouldUnresolvedTransitionToInstalled() {
            ...
            // Then
            assertStateIs(ModuleState.INSTALLED);
        }
    }
    ...
    class Resolved {
        ...
        void shouldResolvedTransitionToStopped() {
            ...
            // Then
            assertStateIs(ModuleState.STOPPED);
        }
    ...
    class Stopped {
        ...
        void shouldStoppedTransitionToStarted() {
            ...
            // Then
            assertStateIs(ModuleState.STARTED);
        }
