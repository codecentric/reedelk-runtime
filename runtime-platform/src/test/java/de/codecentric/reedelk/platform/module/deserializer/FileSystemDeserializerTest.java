...
import de.codecentric.reedelk.platform.commons.ResourcePath;
import de.codecentric.reedelk.platform.module.DeSerializedModule;
import de.codecentric.reedelk.platform.test.utils.TmpDir;
...
class FileSystemDeserializerTest {
    ...
    void shouldDeserializeFlows() throws IOException {
        ...
        Assertions.assertThat(deSerializedModule.getScripts()).isEmpty();
    }
