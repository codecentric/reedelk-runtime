...
class DefaultConfigurationServiceBigDecimalTest extends BaseDefaultConfigurationServiceTest {
    ...
    void shouldThrowExceptionWhenPropertyNotPresentInConfigFile() {
        ...
        ConfigurationPropertyException thrown =
                assertThrows(ConfigurationPropertyException.class, () -> service.getBigDecimalFrom(customConfigFile, TEST_CONFIG_KEY));
    ...
    void shouldThrowExceptionWhenPropertyNotPresentInDefaultConfigFile() {
        ...
        // When
        ConfigurationPropertyException thrown =
                assertThrows(ConfigurationPropertyException.class, () -> service.getBigDecimal(TEST_CONFIG_KEY));
    ...
    void shouldReturnBigDecimalDefaultValueFromGenericConfigProviderAndDefaultConfigFile() {
        ...
        doReturn(defaultValue)
                .when(service)
                .getConfigAdminProperty(eq(DEFAULT_CONFIG_FILE), eq(TEST_CONFIG_KEY), eq(defaultValue),  any(DefaultConfigurationService.InputMapper.class));
