...
class DefaultConfigurationServiceBooleanTest extends BaseDefaultConfigurationServiceTest {
    ...
    void shouldThrowExceptionWhenPropertyNotPresentInConfigFile() {
        ...
        ConfigurationPropertyException thrown =
                assertThrows(ConfigurationPropertyException.class, () -> service.getBooleanFrom(customConfigFile, TEST_CONFIG_KEY));
    ...
    void shouldThrowExceptionWhenPropertyNotPresentInDefaultConfigFile() {
        ...
        // When
        ConfigurationPropertyException thrown =
                assertThrows(ConfigurationPropertyException.class, () -> service.getBoolean(TEST_CONFIG_KEY));
