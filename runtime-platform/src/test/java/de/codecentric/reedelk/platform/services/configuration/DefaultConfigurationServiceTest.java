...
import de.codecentric.reedelk.platform.services.configuration.configurer.ConfigFile;
import de.codecentric.reedelk.platform.services.configuration.configurer.PropertiesConfigFile;
import de.codecentric.reedelk.platform.services.configuration.configurer.XmlConfigFile;
...
class DefaultConfigurationServiceTest extends BaseDefaultConfigurationServiceTest {
    ...
    class InitializeService {
        ...
        void shouldInitializeApplyConfigPropertiesFileCorrectly() throws IOException {
            // Given
            String pid1 = "com.reedelk.platform.custom.components1";
            String pid2 = "com.reedelk.platform.custom.components2";
